...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-navy-950/10 bg-navy-950/85 backdrop-blur">
      ...
      {open && (
        <div className="border-t border-navy-950/10 bg-navy-950 px-5 pb-6 pt-2 lg:hidden">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `rounded-lg px-3 py-3 text-base font-medium ${
                    isActive ? 'bg-navy-950/5 text-accent-light' : 'text-slate-150/85'
                  }`
                }
              >
                {item.label}
