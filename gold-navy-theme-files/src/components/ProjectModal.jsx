  ...
  return (
    ...
    >
      <div
        ...
        className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-t-3xl border border-navy-950/12 bg-navy-900 p-6 shadow-2xl sm:rounded-3xl sm:p-8"
      >
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            onClick={onClose}
            aria-label="閉じる"
            className="shrink-0 rounded-full border border-navy-950/12 p-1.5 text-slate-150/70 hover:bg-navy-950/5"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
