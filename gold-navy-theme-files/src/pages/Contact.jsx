            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <label className="block text-sm">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-navy-950/12 bg-navy-800 px-3.5 py-2.5 text-sm text-slate-150 focus:border-accent focus:outline-none"
                  placeholder="山田 太郎"
                />
              </label>
              <label className="block text-sm">
              ...
              <label className="block text-sm">
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-xl border border-navy-950/12 bg-navy-800 px-3.5 py-2.5 text-sm text-slate-150 focus:border-accent focus:outline-none"
                  placeholder="お問い合わせ内容をご記入ください"
                />
              </label>
              <button
                type="submit"
                className="group inline-flex w-full items-center justify-center gap-2 rounded-full bg-accent px-6 py-3 text-sm font-semibold text-slate-150 transition-colors hover:bg-accent-dark sm:w-auto"
              >
                送信する
